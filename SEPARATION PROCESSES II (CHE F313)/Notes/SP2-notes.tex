...
\text{Cycles per day:}\quad & n_{\text{cyc}}=\frac{24\;\si{\hour}}{t_c\;(\si{\hour})}\\[2pt]
...
\midrule
Microfiltration (MF) & \SI{10}{\micro\meter}--\SI{0.1}{\micro\meter} (100\,nm): suspended solids, bacteria/algae and viruses are held back; water and dissolved ions pass.\\
Ultrafiltration (UF) & \SI{0.1}{\micro\meter}--\SI{0.01}{\micro\meter} (10\,nm): as MF, with viruses rejected more completely; ions still pass.\\
Nanofiltration (NF) & \SI{10}{} nm--\SI{1}{} nm: multivalent ions, viruses, bacteria/algae and suspended solids are rejected; monovalent ions and water pass.\\
...
\end{align*}
\vspace{2pt}
{\small $K_c$ in \si{\centi\meter\per\second}, $D_v$ (diffusivity) in \si{\square\centi\meter\per\second}, $L$ a characteristic length; the boxed correlation is the one the deck uses to get $K_c$.}
\end{formulabox}
